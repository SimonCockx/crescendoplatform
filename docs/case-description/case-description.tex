...
\paragraph{Chirojeugd Vlaanderen} Deze koepelorganisatie van alle Chiro's regelt de verzekeringen van leden, leiders en andere vrijwilligers (bv keukenploeg) doormiddel van het GAP (groepsadministratieportaal).
